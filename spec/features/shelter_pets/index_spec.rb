...
RSpec.describe 'Shelter_Pets index page' do
  before :each do
    ...
    @pet1 = @shelter1.pets.create!(image:"https://hips.hearstapps.com/hmg-prod.s3.amazonaws.com/images/dog-puppy-on-garden-royalty-free-image-1586966191.jpg?crop=1.00xw:0.669xh;0,0.190xh&resize=1200:*", name: "Thor", description: "dog", approximate_age: 2, sex: "male")
